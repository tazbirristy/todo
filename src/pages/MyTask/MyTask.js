...
const MyTask = () => {
  ...
  const handleCompleted = (task) => {
    ...
    fetch(`https://todo-server-dusky.vercel.app/completed/${task._id}`, {
      method: "POST",
      headers: {
  ...
  return (
    <div>
      <h1 className="text-3xl text-blue-500 font-bold my-6 text-center">
        My Tasks
      </h1>
                  ...
                  <>
                    ...
                    <td>
                      <button
                        ...
                        className="px-4  rounded-sm bg-red-900 text-white"
                      >
                        Delete
                      </button>
                    </td>
                    <td>
                      <button
                        ...
                        className="px-4  rounded-sm bg-blue-900 text-white"
                      >
                        Complete Task
                      </button>
                    </td>
